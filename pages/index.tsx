  ...
  return (
    <div className=" bg-slate-400 py-20 px-20 flex flex-col space-y-5 grid gap-10 min-h-screen">
      <div className=" bg-white p-6 rounded-3xl shadow-xl"> 
        ...
        <ul>
          {[1,2,3,4,5].map((i) => (
            <div key={i} className=" flex justify-between my-2 first:bg-blue-50 last:bg-blue-50 odd:bg-blue-50 even:bg-yellow-100">
            ...
            <ul>
              {["a", "b", "c", ""].map((c,i) => (
                <li className="bg-red-500 p-2 empty:bg-blue-500" key={i}>
                    {c}
                  </li> ))}
              </ul>
      ...
      <div className=" bg-white overflow-hidden rounded-3xl shadow-xl group ">
        <div className="bg-blue-500 p-6 pb-14 group-hover:bg-orange-200">
