  ...
  return (
    <div className="px-4 py-10 ">
      <div className="mb-8">
        ...
        <div className=" flex cursor-pointer py-3 border-t border-b  items-center space-x3">
        ...
        <div className="mt-5 ">
          ...
          <p className="text-3xl mt-3 text-gray-800">$140</p>
          ...
          <div className="flex items-center justify-between space-x-3">
            <button className="flex-1 bg-orange-500 text-white py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 font-medium hover:bg-orange-600 ">Talk to seller
            </button>
