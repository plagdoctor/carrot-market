      ...
      <div className="px-4  py-4">
        <div className="mb-8">
          <div className=" relative pb-80"> 
            <Image src={`https://imagedelivery.net/anLhvYjm508UkDZ_aeVt9g/${data?.product.image}/public`} layout="fill" className=" object-cover bg-slate-300" />
          </div>
          <div className="flex cursor-pointer py-3 border-t border-b items-center space-x-3">
            {user?.avatar ? <Image src={`https://imagedelivery.net/anLhvYjm508UkDZ_aeVt9g/${data?.product.user.avatar}/public`} width={48} height={48} className="w-12 h-12 rounded-full bg-slate-300" /> 
          ...
          <div className="mt-5">
            ...
            <div className="flex items-center justify-between space-x-2">
              ...
              {data?.isLiked ? ( 
                ...
                <path fillRule="evenodd" d="M3.172 5.172a4 4 0 015.656 0L10 6.343l1.172-1.171a4 4 0 115.656 5.656L10 17.657l-6.828-6.829a4 4 0 010-5.656z" clipRule="evenodd"></path></svg> )
                : (<svg
                  className="h-6 w-6 "
