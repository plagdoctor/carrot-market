  ...
  return (
    <Layout canGoBack>
      <div className="px-4  py-4">
        <div className="mb-8">
          <img src={`https://imagedelivery.net/anLhvYjm508UkDZ_aeVt9g/${data?.product.image}/public`} className="h-96 bg-slate-300" />
          <div className="flex cursor-pointer py-3 border-t border-b items-center space-x-3">
            {user?.avatar ? <img src={`https://imagedelivery.net/anLhvYjm508UkDZ_aeVt9g/${data?.product.user.avatar}/public`} className="w-12 h-12 rounded-full bg-slate-300" /> 
