...
<div className="py-10 px-4">
      ...
      <div className=" mt-10 flex justify-around">
        <div className=" flex flex-col items-center">
          <div className="w-14 h-14 flex flex-col items-center bg-orange-500 rounded-full text-white justify-center">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
          ...
          <span className=" mt-2 text-gray-700 text-sm font-medium">판매내역</span>
        </div>
        <div className=" flex flex-col items-center">
          <div className="w-14 h-14 flex flex-col items-center bg-orange-500 rounded-full text-white justify-center">
            <svg
          ...
          <span className=" mt-2 text-gray-700 text-sm font-medium">구매내역</span>
        </div>
        <div className=" flex flex-col items-center">
          <div className="w-14 h-14 flex flex-col items-center bg-orange-500 rounded-full text-white justify-center">
            <svg
          ...
          <span className=" mt-2 text-gray-700 text-sm font-medium">관심목록</span>
        </div>
      </div>
      <div className="mt-12">
        <div className="flex space-x-4 items-center">
          ...
          <div>
            <h4 className=" font-bold text-sm text-slate-800 ">니꼬</h4>
